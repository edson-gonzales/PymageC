...
class FileManagerTest(unittest.TestCase):
    ...
    def test_list_image_sizes_from_path_return_a_list_with_image_sizes(self):
        ...
        self.assertEquals([154844L, 8170L, 551980L, 154844L, 73695L, 64186L, 8170L, 45789L, 25612L], self.file_manager.list_image_sizes_from_path(self.current_path))

    def test_list_image_sizes_from_path_return_a_list_with_image_sizes_with_three_matching_files_and_one_different(self):
        
        folder = "/input/moreimages"
        path = self.current_path + folder
        self.assertEquals([154844L, 73695L, 64186L, 8170L, 45789L, 25612L], self.file_manager.list_image_sizes_from_path(path))
