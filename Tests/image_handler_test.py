...
class ImageManagerTest(unittest.TestCase):
    ...
    def test_validate_degrees_inserted_sending_number_in_the_valid_range(self):
        self.assertTrue(self.image_handler.validate_degrees_inserted(180), "180 degrees should be permitted")

    def test_validate_degrees_inserted_sending_number_outside_the_lower_limit(self):
        self.assertFalse(self.image_handler.validate_degrees_inserted(-361), "There is an issue in the lower limit")
    
    def test_validate_degrees_inserted_sending_number_outside_the_upper_limit(self):
        self.assertFalse(self.image_handler.validate_degrees_inserted(361), "There is an issue in the upper limit")

    def test_validate_format_inserted_returns_true_when_the_format_inserted_is_supported(self):
        self.assertTrue(self.image_handler.validate_format_inserted("png"), "The format inserted is is incorrect on is not supported")
        self.assertTrue(self.image_handler.validate_format_inserted("jpg"), "The format inserted is is incorrect on is not supported")
        self.assertTrue(self.image_handler.validate_format_inserted("bmp"), "The format inserted is is incorrect on is not supported")

    def test_validate_format_inserted_returns_false_when_insert_a_format_not_supported(self):
        self.assertFalse(self.image_handler.validate_format_inserted("ico"), "This format is not supported")
    ...
    def test_rotate_image_creates_new_image_file_with_image_rotated_using_jpg_type(self):
        ...
        self.image_handler.rotate_image(input_values)
        self.assertTrue(self.file_manager.validate_type_of_image(new_name_jpg_path), "A new image was not created")
    ...
    def test_rotate_image_creates_new_image_file_with_image_rotated_using_png_type(self):
        ...
        self.image_handler.rotate_image(input_values)
        self.assertTrue(self.file_manager.validate_type_of_image(new_name_png_path), "A new image was not created")
    ...
    def test_rotate_image_creates_new_image_file_with_image_rotated_using_bmp_type(self):
        ...
        self.image_handler.rotate_image(input_values)
        self.assertTrue(self.file_manager.validate_type_of_image(new_name_bmp_path), "A new image was not created")
    ...
    def test_export_a_jpg_image_file_to_png_image_file(self):
        ...
        self.image_handler.export_an_image_file_to_another_format(input_values)
